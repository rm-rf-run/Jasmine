...
<div class="jasmine-comment-part">
    ...
    $comment_before = '';
    $comment_cancel = '取消回复';
    $comment_bird = '<div style="float:left;padding-top: 10px;"><img class="lazyload" id="author_img" data-src="' . get_template_directory_uri() . '/assets/images/avatarBird.png" height="48" width="48" style="border-radius: 8px;"></div>';
    //Array
    $comments_args = array(
        //Define Fields
        'fields' => array(
