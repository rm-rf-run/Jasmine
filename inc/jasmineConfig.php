...
jasmineConfig.loveStartTime = "<?php echo get_option('jasmine_loveDate') ? get_option('jasmine_loveDate') : null;?>";

jasmineConfig.siteStartTime = "<?php echo get_option('jasmine_startDate') ? get_option('jasmine_startDate') : null;?>";

jasmineConfig.author_data = "<?php echo get_option('jasmine_author_data') ? get_option('jasmine_author_data') : null;?>";
...
jasmineConfig.clipboardCopyright = "<?php echo esc_attr(get_option('jasmine_copyright')) == 'checked' ? 'true' : 'false';?>";
