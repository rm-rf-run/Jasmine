...
class Simple_Local_Avatars
{
    ...
    public function get_avatar($avatar = '', $id_or_email, $size = 50, $default = '', $alt = false)
    {
        ...
        $avatar       = "<img alt='" . esc_attr($alt) . "' src='" . $local_avatars['full'] . "' data-src='". $local_avatars['full'] ."' class='avatar avatar-{$size}{$author_class} photo lazyload' height='{$size}' width='{$size}' />";
