...
function optionsframework_options()
{
    ...
    $options[] = array(
        ...
        'id'   => 'jasmine_post_api',
        'std'  => 'https://api.ixiaowai.cn/gqapi/gqapi.php,https://api.ixiaowai.cn/api/api.php,http://api.btstu.cn/sjbz/?lx=dongman,http://api.btstu.cn/sjbz/?lx=suiji,https://img.xjh.me/random_img.php?type=bg&ctype=nature&return=302,https://api.loli.rocks/tianshijianglindaowoshenbian/index.php,https://api.ixiaowai.cn/gqapi/gqapi.php,https://random.52ecy.cn/randbg.php,https://uploadbeta.com/api/pictures/random/?key=BingEverydayWallpaperPicture,http://www.dmoe.cc/random.php,https://acg.yanwz.cn/api.php,https://img.paulzzh.tech/touhou/random',
        'type' => 'textarea',
    );
